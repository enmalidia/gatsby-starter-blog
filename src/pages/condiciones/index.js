...
import OrderBlock from "../../components/conditions/orderBlock"
...
const ConditionsPage = () => {
  ...
  return (
    <Layout>
      <Seo title="Services" />
      <OneColumnLeftText header={pageData.header} title={pageData.title} description={pageData.description} details={pageData.details} color={"ashford"} dark/>
